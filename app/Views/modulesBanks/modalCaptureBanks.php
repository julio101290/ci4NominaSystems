                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                   ...
                                   <select class="form-control select" name="omision" id="omision" style="width: 90%;">

                                    <option value="No" selected><?= lang('banks.fields.omisionNo') ?></option>
                                    <option value="Yes" selected><?= lang('banks.fields.omisionYes') ?></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <select class="form-control select" name="keySAT" id="keySAT" style="width: 90%;">

                                    <option value="0" selected><?= lang('banks.fields.keySatSelect') ?></option>

                                    <?php
                                    foreach ($banksSat as $key => $value) {
