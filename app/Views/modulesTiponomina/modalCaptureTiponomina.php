...
<div class="form-group row">
    <label for="idEmpresa" class="col-sm-2 col-form-label"><?= lang('tiponomina.fields.idEmpresa') ?></label>
    <div class="col-sm-10">
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
            </div>
            <input type="text" name="idEmpresa" id="idEmpresa" class="form-control <?= session('error.idEmpresa') ? 'is-invalid' : '' ?>" value="<?= old('idEmpresa') ?>" placeholder="<?= lang('tiponomina.fields.idEmpresa') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="idSucursal" id="idSucursal" class="form-control <?= session('error.idSucursal') ? 'is-invalid' : '' ?>" value="<?= old('idSucursal') ?>" placeholder="<?= lang('tiponomina.fields.idSucursal') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="entidadFederativa" id="entidadFederativa" class="form-control <?= session('error.entidadFederativa') ? 'is-invalid' : '' ?>" value="<?= old('entidadFederativa') ?>" placeholder="<?= lang('tiponomina.fields.entidadFederativa') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="riesgoPto" id="riesgoPto" class="form-control <?= session('error.riesgoPto') ? 'is-invalid' : '' ?>" value="<?= old('riesgoPto') ?>" placeholder="<?= lang('tiponomina.fields.riesgoPto') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="areaSalMin" id="areaSalMin" class="form-control <?= session('error.areaSalMin') ? 'is-invalid' : '' ?>" value="<?= old('areaSalMin') ?>" placeholder="<?= lang('tiponomina.fields.areaSalMin') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
