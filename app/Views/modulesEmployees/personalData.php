    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <select class="form-control select" name="sex" id="sex" style="width: 80%;">
                ...
                <option value="0"><?= lang('employees.fields.sexSelect') ?></option>
                <option value="male"><?= lang('employees.fields.sexMale') ?></option>
                <option value="fermale"><?= lang('employees.fields.sexFermale') ?></option>
