...
<script>
    ...
    var tableBranchoffices = $('#tableBranchoffices').DataTable({
        ...
        ajax: {
            url: '<?= base_url(route_to('admin/branchoffices')) ?>',
            method: 'GET',
            dataType: "json"
        },
        columnDefs: [{
    ...
    $(document).on('click', '#btnSaveBranchoffices', function (e) {
        ...
        $.ajax({
            ...
            url: "<?= route_to('admin/branchoffices/save') ?>",
            method: "POST",
            data: datos,
            cache: false,
            contentType: false,
    ...
    $(".tableBranchoffices").on("click", ".btnEditBranchoffices", function () {
        ...
        $.ajax({
            ...
            url: "<?= base_url(route_to('admin/branchoffices/getBranchoffices')) ?>",
            method: "POST",
            data: datos,
            cache: false,
            contentType: false,
        ...
        Swal.fire({
            ...
            confirmButtonText: '<?= lang('boilerplate.global.sweet.confirm_delete') ?>'
                ...
                .then((result) => {
                    if (result.value) {
                        $.ajax({
                            url: `<?= base_url(route_to('admin/branchoffices')) ?>/` + idBranchoffices,
                            method: 'DELETE',
