  ...
  <div class="modal fade" id="modalAddNominas" tabindex="-1" role="dialog" aria-labelledby="modalAddNominas" aria-hidden="true">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="idEmpresa" id="idEmpresa" class="form-control <?= session('error.idEmpresa') ? 'is-invalid' : '' ?>" value="<?= old('idEmpresa') ?>" placeholder="<?= lang('nominas.fields.idEmpresa') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="idTipoNominas" id="idTipoNominas" class="form-control <?= session('error.idTipoNominas') ? 'is-invalid' : '' ?>" value="<?= old('idTipoNominas') ?>" placeholder="<?= lang('nominas.fields.idTipoNominas') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="fechaInicial" id="fechaInicial" class="form-control <?= session('error.fechaInicial') ? 'is-invalid' : '' ?>" value="<?= old('fechaInicial') ?>" placeholder="<?= lang('nominas.fields.fechaInicial') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="fechaFinal" id="fechaFinal" class="form-control <?= session('error.fechaFinal') ? 'is-invalid' : '' ?>" value="<?= old('fechaFinal') ?>" placeholder="<?= lang('nominas.fields.fechaFinal') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            <input type="text" name="fechaAplicacion" id="fechaAplicacion" class="form-control <?= session('error.fechaAplicacion') ? 'is-invalid' : '' ?>" value="<?= old('fechaAplicacion') ?>" placeholder="<?= lang('nominas.fields.fechaAplicacion') ?>" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group row">
